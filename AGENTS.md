...
- Of the defects found while building Plan 4, OAuth login-CSRF (#53) and the e2e workspace/baseline defects (#57, #58) are fixed. The duplicated app modules (#54), degraded-response fallback (#55), and shared-core workspace-loss relocation (#56) remain open.
