...
interface GoogleAuthConfig {
  ...
  redirectUri: string;
  /**
   * Builds the `state` to pass through Google OAuth. A function rather than a
   * string because the CSRF nonce has to be minted — and remembered for the
   * callback to compare against — at the moment the user starts the flow, not
   * while rendering. Callers append their carriers via
...
export function LoginPage({
  ...
  const handleGoogleLogin = () => {
    ...
    // Minted here, once per click: a nonce generated during render would be
    // regenerated by every re-render and could not be matched on the way back.
